...
Mantido pelo chat de planejamento (Claude.ai Project). Última atualização: 2026-06-30.
...
- [ ] FC-1 — Expandir/colapsar totalizadores (chevron + botões "Expandir tudo"/"Colapsar tudo")
- [ ] FC-2 — Coluna de Participação % opcional no modo "Todos os meses"
- [ ] FC-3 — Detalhamento de lançamentos por agrupamento (painel inline, qualquer seção do demonstrativo)
- [ ] FC-4 — Exportar Fluxo de Caixa em PDF (weasyprint, formatado com logo E Mais)
...
- [ ] DEMO-7 — Template Orçamento (mesma estrutura de linhas do DRE/FC para permitir comparativo)
