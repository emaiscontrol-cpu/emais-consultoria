...
const SECOES = [
  ...
  {
    id: 'planos', titulo: '16. Plano de Contas Referencial',
    conteudo: [
      { tipo: 'texto', texto: 'O Plano de Contas Referencial é a estrutura contábil centralizada do sistema. Diferente do modelo anterior, o plano é compartilhado e cada cliente mapeia suas contas ao referencial via De-Para.' },
      { tipo: 'subtitulo', texto: 'Acesso' },
      { tipo: 'lista', itens: [
        'Acesse Plano de Contas no menu lateral (seção Procedimentos)',
        'O módulo exibe o plano referencial e permite criar templates e De-Para por cliente',
      ]},
      { tipo: 'subtitulo', texto: 'Estrutura de contas' },
      ...
      { tipo: 'subtitulo', texto: 'De-Para por cliente' },
      { tipo: 'texto', texto: 'Cada cliente mapeia os códigos do seu ERP para as contas referenciais usando o De-Para. Na importação, o sistema aplica o mapeamento automaticamente.' },
    ],
  },
  {
  ...
  },
  {
    ...
    conteudo: [
      ...
      { tipo: 'aviso', texto: 'Se o cliente não tiver contas configuradas no Plano de Contas Referencial, as demonstrações exibirão aviso de "Nenhum plano vinculado". Configure o De-Para do cliente no módulo Plano de Contas.' },
    ],
  },
  {
